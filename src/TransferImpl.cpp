...
void LibUSB::ControlTransferImpl::Setup()
{
    ...
    libusb_fill_control_transfer(m_pTransfer.get(), m_pEndpointImpl.lock()->getDeviceImpl().lock()->m_pHandle.get(), m_pTransferBuffer.get(), AsyncTransferCallback, this, m_Timeout);
